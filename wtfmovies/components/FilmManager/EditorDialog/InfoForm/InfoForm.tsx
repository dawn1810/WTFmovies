    ...
    return (
        <Box sx={{ margin: '0 auto', height: '100%', display: 'flex', flexDirection: 'column' }}>
            {useMemo(
                ...
                [cropResult, cropResultBanner, imgBannerMovie, imgMovie]
            )}
            ...
            <Box
                ...
                sx={{
                    ...
                    '& #movie-title': { width: '50ch' },
                    '& #movie-sumary': { width: '50ch' },
            ...
            >
                <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 1 }}>
                    ...
                    <TextField
                        ...
                        rows={12.5}
                        value={sumaryMovie}
                        onChange={(event) => setSumaryMovie(event.target.value)}
                    />
                </Box>
                <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', width: '30vw', gap: 1 }}>
                    <AutocompleteBox
                    ...
                    <TextField
                        ...
                        label="Nhãn"
                        value={valueTag}
                        onChange={(event) => setvValueTag(event.target.value)}
                    >
                        {tags.map((option) => (
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 1 }}>
                    ...
                    <TextField
                        onChange={(event) => {
                            Number(event.target.value) < 1 ? (event.target.value = '1') : event.target.value;
