...
const icons = [
    <VisibilityOutlinedIcon key="visibility" />,
    <FavoriteBorderOutlinedIcon key="favorite" />,
    <PendingActionsIcon key="pending" />,
    <HistoryEduIcon key="history" />,
    <CategoryIcon key="category" />,
    <VideocamIcon key="videocam" />,
    <HourglassEmptyIcon key="hourglass" />,
    <Filter9PlusIcon key="filter9" />,
    <LocalOfferIcon key="localoffer" />,
    <CalendarMonthIcon key="calendar" />,
    <FmdGoodOutlinedIcon key="fmdgood" />,
    <DirectionsRunIcon key="directionsrun" />,
    <LooksOneOutlinedIcon key="lookone" />,
];
