                    ...
                    <TableBody>
                        {rows.map((row) =>
                            <TableRow key={row._id}>
                                ...
                                {row.username && (
                                    <TableCell component="th" scope="row" className={cx('table-cell')} key={`${row._id}-username`}>
                                        {row.username}
                                    </TableCell>
                                )}
                                <TableCell component="th" scope="row" className={cx('table-cell')} key={`${row._id}-content`}>
                                    {row.content}
                                </TableCell>
                                <TableCell align="left" className={cx('table-cell')} key={`${row._id}-time`}>
                                    {timePassed(row.time)}
                                </TableCell>
                            </TableRow>
                        )}
